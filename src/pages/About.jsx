...
export default function About() {
  return (
    <div className="pt-32 pb-24 relative overflow-hidden">
      ...
      <div className="absolute top-1/3 left-0 w-[250px] h-[250px] md:w-[450px] md:h-[450px] bg-brand-glowPurple/5 rounded-full blur-[60px] md:blur-[130px] pointer-events-none transform-gpu" />
      <div className="absolute bottom-1/4 right-0 w-[250px] h-[250px] md:w-[450px] md:h-[450px] bg-brand-glowBlue/5 rounded-full blur-[60px] md:blur-[130px] pointer-events-none transform-gpu" />
